package org.json.android.junit;
...
import org.json.android.CDL;
import org.json.android.JSONArray;
import org.json.android.JSONException;
import org.json.android.JSONObject;
import org.json.android.JSONPointerException;
import org.json.android.JSONString;
import org.json.android.JSONTokener;
import org.json.android.XML;
import org.json.android.junit.data.BrokenToString;
import org.json.android.junit.data.ExceptionalBean;
import org.json.android.junit.data.Fraction;
import org.json.android.junit.data.GenericBean;
import org.json.android.junit.data.GenericBeanInt;
import org.json.android.junit.data.MyBean;
import org.json.android.junit.data.MyBeanCustomName;
import org.json.android.junit.data.MyBeanCustomNameSubClass;
import org.json.android.junit.data.MyBigNumberBean;
import org.json.android.junit.data.MyEnum;
import org.json.android.junit.data.MyEnumField;
import org.json.android.junit.data.MyJsonString;
import org.json.android.junit.data.MyNumber;
import org.json.android.junit.data.MyNumberContainer;
import org.json.android.junit.data.MyPublicClass;
import org.json.android.junit.data.RecursiveBean;
import org.json.android.junit.data.RecursiveBeanEquals;
import org.json.android.junit.data.Singleton;
import org.json.android.junit.data.SingletonEnum;
import org.json.android.junit.data.WeirdList;
    ...
    public void jsonObjectParsingErrors() {
        ...
        try {
            ...
            String str = "{\n"
                    ...
                    +"    \"attr03\":\"value-03\",\n"
                    +"    \"attr03\": {"
                    +"        \"attr04-01\":\"value-04-01\",\n"
                    +"        \"attr04-02\":\"value-04-02\",\n"
                    +"        \"attr04-03\":\"value-04-03\"\n"
                    + "    }\n"
                    + "}";
            new JSONObject(str);
            // [FORK]
...
//        assertTrue("should convert null to empty string", "".equals(string));
    ...
    /**
     * [FORK]
     * A JSONObject order should match Android implementation
     */
    @Test
    public void testOrderPreserve() {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("z", 1);
        jsonObject.put("y", 2);
        jsonObject.put("a", 3);
        jsonObject.put("zz", new JSONObject());
        assertEquals("jsonObject order shouldn't change", "{\"z\":1,\"y\":2,\"a\":3,\"zz\":{}}", jsonObject.toString());
    }
}
